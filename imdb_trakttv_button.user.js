...
(function() {
    ...
    const id = document.body.parentElement.querySelector('[property="pageId"]').content;
    let a = document.createElement('a'); {
        a.href = `https://trakt.tv/search/imdb/${id}`;
        ...
        container.insertBefore(a, container.children[1]);
    }
})();
